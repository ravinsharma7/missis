...
const beginReadme = "<!-- BEGIN GENERATED MISSIS ONBOARDING -->"
const endReadme = "<!-- END GENERATED MISSIS ONBOARDING -->"

// AgentSetup renders the standalone, version-neutral external-project guide.
func AgentSetup() string {
	return strings.TrimSpace(`# Clean Missis setup for an external project
...
// ReadmeSection is the concise repository entry point generated from the same
// command model as the standalone guide.
func ReadmeSection() string {
	return beginReadme + "\n" + strings.TrimSpace(`## Install and set up a project
...
func ReadmeMarkers() (string, string) { return beginReadme, endReadme }
