...
AG6: read .missis.d/context.md and current missis tickets before starting implementation work.
AG7: read .missis.d/active.md to determine the active project, group, and ticket focus for this session.
